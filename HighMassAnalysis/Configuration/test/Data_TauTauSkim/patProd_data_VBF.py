...
'/store/data/Run2012C/VBF1Parked/AOD/22Jan2013-v1/20000/002823AC-A079-E211-A847-00259059649C.root'
        )
  )
else:
  process.load("Configuration.Geometry.GeometryIdeal_cff")
...
if(channel == "singleE"):
  process.load("HighMassAnalysis.Skimming.elecSkimSequence_cff")
  process.theSkim = cms.Sequence(
    process.elecSkimSequence
  )
...
#     process.SusyHLTFilter
  process.genLevelSelection = cms.Sequence(  )
if(channel == "singleMu"):
  process.load("HighMassAnalysis.Skimming.singleMuSkimSequence_cff")
  process.theSkim = cms.Sequence( process.singleMuSkimSequence )
  process.hltFilter = cms.Sequence( process.mutauHLTFilter )
  process.genLevelSelection = cms.Sequence(  )
if(channel == "vbf"):
  process.theVBFSkim = cms.EDFilter("VBFSkim")
  process.load("HighMassAnalysis.Skimming.VBFSkimSequence_cff")
  process.theSkim = cms.Sequence( process.selectedVBFJets * process.theVBFSkim * process.VBFMetFilter )
  process.hltFilter = cms.Sequence( process.vbfHLTFilter )
  process.genLevelSelection = cms.Sequence(  )
