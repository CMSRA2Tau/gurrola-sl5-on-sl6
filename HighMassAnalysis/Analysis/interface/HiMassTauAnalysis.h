...
private:
  ...
  void dumpRecoJet1Info(const pat::Jet&,int);
  bool passEventSelectionSequence();
  bool pass_i_EventSelectionSequence(unsigned int);
  bool passRecoTrigger1Cuts(const Event&);
  bool passRecoTrigger2Cuts(const Event&);
  ...
  bool passRecoCentralJetCuts(const pat::Jet&,int);
  bool passRecoJet1Cuts(const pat::Jet&,int);
  bool passRecoJet2Cuts(const pat::Jet&,int);
  ...
  bool passDiJetTopologyCuts(const pat::Jet&, int, const pat::Jet&, int);
  bool passDiElectronTopologyCuts(const pat::Electron&, int,const pat::Electron&, int);
  bool passSusyTopologyCuts(int, int);
  bool passRecoMuon1MetTopologyCuts(const pat::Muon&, int);
  bool passRecoMuon2MetTopologyCuts(const pat::Muon&, int);
  bool passRecoElectron1MetTopologyCuts(const pat::Electron&, int);
  bool passRecoElectron2MetTopologyCuts(const pat::Electron&, int);
  bool passRecoTau1MetTopologyCuts(const pat::Tau&, int);
  bool passRecoTau2MetTopologyCuts(const pat::Tau&, int);
  bool passedLooseJetID(const pat::Jet&,int);
  bool passedPileupJetID(int);
  ...
  int matchToGenDecayMode(const pat::Tau&);
  ...
  void bookHistograms(string, unsigned int);
  ...
  bool _RemoveTau1OverlapWithMuon1s;
  bool _RemoveTau1OverlapWithElectron1s;
  bool _RemoveTau1OverlapWithMuon2s;
  bool _RemoveTau1OverlapWithElectron2s;
  bool _RemoveTau2OverlapWithMuon1s;
  bool _RemoveTau2OverlapWithElectron1s;
  bool _RemoveTau2OverlapWithMuon2s;
  bool _RemoveTau2OverlapWithElectron2s;
  ...
  double _RecoMuon1IsoSumPtMinCutValue;
  double _RecoMuon1IsoSumPtMaxCutValue;
  ...
  bool _DoRecoMuon1DiscrByDptOpt;
  double _RecoMuon1DptOptMaxCut;
  double _RecoMuon2PtMinCut;
  double _RecoMuon2PtMaxCut;
  double _RecoMuon2EtaCut;
  double _RecoMuon2IsoSumPtMinCutValue;
  double _RecoMuon2IsoSumPtMaxCutValue;
  ...
  bool _DoRecoMuon2DiscrByDptOpt;
  double _RecoMuon2DptOptMaxCut;

  //-----Reco Electron Inputs
  InputTag _RecoElectronSource;
  typedef std::vector< edm::Handle< edm::ValueMap<double> > > IsoDepositVals;
  std::vector<edm::InputTag> _IsoValElecPFVInputTag;
//  const IsoDepositVals * electronIsoVals;
  IsoDepositVals _elecIsoValPFIdDr04;
  double _RecoElectron1PtMinCut;
  double _RecoElectron1PtMaxCut;
  double _RecoElectron1EtaCut;
  double _RecoElectron1IsoSumPtMaxCutValue;
  double _RecoElectron1IsoSumPtMinCutValue;
  double _RecoElectron1IpCut;  
  double _RecoElectron1dzCut;  
  double _RecoElectron1EoverPMax;
  double _RecoElectron1EoverPMin;
  double _RecoElectron1EEHoverEmCut;
  double _RecoElectron1EBHoverEmCut;
  bool _UseHeepInfo;
  bool _DoRecoElectron1DiscrByIsolation;
//  bool _CalculateRecoElectron1IsolationUsingIsoDeposits;
  string _RecoElectron1IsolationCone;
  ...
  double _RecoElectron1EESigmaIEtaIEta;
  double _RecoElectron1EBSigmaIEtaIEta;
  ...
  double _RecoElectron2IsoSumPtMaxCutValue;
  double _RecoElectron2IsoSumPtMinCutValue;
  double _RecoElectron2IpCut;  
  double _RecoElectron2dzCut;  
  double _RecoElectron2EoverPMax;
  double _RecoElectron2EoverPMin;
  double _RecoElectron2EEHoverEmCut;
  double _RecoElectron2EBHoverEmCut;
  bool _DoRecoElectron2DiscrByIsolation;
  bool _CalculateRecoElectron2IsolationUsingIsoDeposits;
  string _RecoElectron2IsolationCone;
  ...
  double _RecoElectron2EESigmaIEtaIEta;
  double _RecoElectron2EBSigmaIEtaIEta;
  ...
  string _puJetIdwp;
  bool _UsePUjetId;
  int _RecoGoodPUjetsNmin;
  double _RecoJet1PtCut;
  double _RecoJet1EtaMinCut;
  double _RecoJet1EtaMaxCut;
  double _Jet1Muon1MatchingDeltaR;
  double _Jet1Electron1MatchingDeltaR;
  double _Jet1Tau1MatchingDeltaR;
  double _Jet1Muon2MatchingDeltaR;
  double _Jet1Electron2MatchingDeltaR;
  double _Jet1Tau2MatchingDeltaR;
  double _RecoJet2PtCut;
  double _RecoJet2EtaMinCut;
  double _RecoJet2EtaMaxCut;
  double _Jet2Muon1MatchingDeltaR;
  double _Jet2Electron1MatchingDeltaR;
  double _Jet2Tau1MatchingDeltaR;
  double _Jet2Muon2MatchingDeltaR;
  double _Jet2Electron2MatchingDeltaR;
  double _Jet2Tau2MatchingDeltaR;
  double _RecoCentralJetPtCut;
  double _CentralJetMuon1MatchingDeltaR;
  double _CentralJetElectron1MatchingDeltaR;
  double _CentralJetTau1MatchingDeltaR;
  double _CentralJetMuon2MatchingDeltaR;
  double _CentralJetElectron2MatchingDeltaR;
  double _CentralJetTau2MatchingDeltaR;
...
//  double _JetBTaggingTCHEcut;
  ...
  bool _ApplyJet1LooseID;
  bool _ApplyJet2LooseID;
  bool _ApplyCentralJetLooseID;
  bool _ApplyLeadingJetsLooseID;
  bool _ApplyJetLooseIDforMhtAndHt;

  bool _ApplyJet1PileupID;
  bool _ApplyJet2PileupID;
  bool _ApplyCentralJetPileupID;
  bool _ApplyLeadingJetsPileupID;
  bool _ApplyJetPileupIDforMhtAndHt;

  bool _RemoveJet1OverlapWithMuon1s;
  bool _RemoveJet1OverlapWithElectron1s;
  bool _RemoveJet1OverlapWithTau1s;
  bool _RemoveJet1OverlapWithMuon2s;
  bool _RemoveJet1OverlapWithElectron2s;
  bool _RemoveJet1OverlapWithTau2s;
  bool _RemoveJet2OverlapWithMuon1s;
  bool _RemoveJet2OverlapWithElectron1s;
  bool _RemoveJet2OverlapWithTau1s;
  bool _RemoveJet2OverlapWithMuon2s;
  bool _RemoveJet2OverlapWithElectron2s;
  bool _RemoveJet2OverlapWithTau2s;
  bool _RemoveCentralJetOverlapWithMuon1s;
  bool _RemoveCentralJetOverlapWithElectron1s;
  bool _RemoveCentralJetOverlapWithTau1s;
  bool _RemoveCentralJetOverlapWithMuon2s;
  bool _RemoveCentralJetOverlapWithElectron2s;
  bool _RemoveCentralJetOverlapWithTau2s;
  ...
  std::vector<std::string> _Trigger1Requirements;
  std::vector<std::string> _Trigger2Requirements;

  //-----Topology Inputs
  InputTag _RecoMetSource;
  double _RecoMetMinCut;
  double _RecoMetMaxCut;
  ...
  double _DiTauCDFzeta2DMinCutValue;
  double _DiTauCDFzeta2DMaxCutValue;
  ...
  double _DiMuonCDFzeta2DMinCutValue;
  double _DiMuonCDFzeta2DMaxCutValue;
  ...
  double _DiElectronCDFzeta2DMinCutValue;
  double _DiElectronCDFzeta2DMaxCutValue;
  ...
  double _Muon1Tau1CDFzeta2DMinCutValue;
  double _Muon1Tau1CDFzeta2DMaxCutValue;
  ...
  double _Muon1Tau2CDFzeta2DMinCutValue;
  double _Muon1Tau2CDFzeta2DMaxCutValue;
  ...
  double _Muon2Tau1CDFzeta2DMinCutValue;
  double _Muon2Tau1CDFzeta2DMaxCutValue;
  ...
  double _Muon2Tau2CDFzeta2DMinCutValue;
  double _Muon2Tau2CDFzeta2DMaxCutValue;
  ...
  double _Electron1Tau1CDFzeta2DMinCutValue;
  double _Electron1Tau1CDFzeta2DMaxCutValue;
  ...
  double _Electron1Tau2CDFzeta2DMinCutValue;
  double _Electron1Tau2CDFzeta2DMaxCutValue;
  ...
  double _Electron2Tau1CDFzeta2DMinCutValue;
  double _Electron2Tau1CDFzeta2DMaxCutValue;
  ...
  double _Electron2Tau2CDFzeta2DMinCutValue;
  double _Electron2Tau2CDFzeta2DMaxCutValue;
  ...
  double _Electron1Muon1CDFzeta2DMinCutValue;
  double _Electron1Muon1CDFzeta2DMaxCutValue;
  ...
  double _Electron1Muon2CDFzeta2DMinCutValue;
  double _Electron1Muon2CDFzeta2DMaxCutValue;
  ...
  double _Electron2Muon1CDFzeta2DMinCutValue;
  double _Electron2Muon1CDFzeta2DMaxCutValue;
  ...
  double _Electron2Muon2CDFzeta2DMinCutValue;
  double _Electron2Muon2CDFzeta2DMaxCutValue;
  ...
  bool _DoDiscrByMet;
  bool _DoDiJetDiscrByDeltaR;
  double _DiJetDeltaRCut;
  bool _DoDiJetDiscrByDeltaEta;
  double _DiJetMinDeltaEtaCut;
  double _DiJetMaxDeltaEtaCut;
  bool _DoDiJetDiscrByDeltaPhi;
  double _DiJetMinDeltaPhiCut;
  double _DiJetMaxDeltaPhiCut;
  bool _DoDiJetDiscrByOSEta;
  bool _DoDiJetDiscrByCosDphi;
  double _DiJetCosDphiMinCut;
  double _DiJetCosDphiMaxCut;
  bool _DoDiscrByDiJetMassReco;
  double _DiJetMassMinCut;
  double _DiJetMassMaxCut;
  ...
  double _JetPtForMhtAndHt;
  double _JetEtaForMhtAndHt;
  ...
  bool _DoSUSYDiscrByLeadDiJetDeltaPhi;
  double _LeadDiJetMinDeltaPhiCut;
  double _LeadDiJetMaxDeltaPhiCut;
  bool _DoSUSYDiscrByLeadDiJetOSEta;
  ...
  std::vector<std::string> _TauDecayModeType;
  ...
  //-----vertex histograms
  //std::map< unsigned int, std::map<unsigned int, TH1*>> _hVertexZposition;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hVertexZposition;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hVertexNTracks;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hNPVertices;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hNVertices;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hNVertices_andres;
  TDirectory *cdtof;
   TFile* rootTFile;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hLSPMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hStauMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenTauEnergy;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenTauPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenTauPtResponse;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenTauEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenTauPtBeforeDecay;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenTauEtaBeforeDecay;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenTauMotherEnergy;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenTauMotherPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenTauMotherEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenTauMotherPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenTauGrandMotherEnergy;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenTauGrandMotherPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenTauGrandMotherEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenTauGrandMotherPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenNeutralPionRecoPiZeroDeltaR;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenChargedPionTrackDeltaR;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenChargedPionTrackDeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenChargedPionPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenChargedPionPtMatched;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenChargedPionTrackHits;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenChargedPionTrackDxy;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenChargedPionTrackDz;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hGenChargedPionTrackChi2;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1AlternatePt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1PtWithSeedTrack;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1PtWithMuonRef;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1PtWithoutMuonSegments;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1PtWithNeutralHadrCands;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1NumSignalNeutralHads;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1NumSignalGammas;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SeedTrackPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SeedTrackIpSignificance;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SeedTrackNhits;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SeedTrackChi2;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1Charge;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SignalTracksMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SignalTracksAndGammasMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SignalTracksMass1prong;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SignalTracksAndGammasMass1prong;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SignalTracksAndPiZerosMass1prong;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SignalTracksAndPiZerosMass3prong;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SignalTracksAndPiZerosMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1NumSignalPiZeros1prong;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1NumSignalPiZeros3prong;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SignalTracksMass3prong;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SignalTracksAndGammasMass3prong;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1Mass1Prong0PiZeros;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1Mass1Prong1PiZeros;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1Mass1Prong2orMorePiZeros;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1Mass3Prong0PiZeros;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1Mass3Prong1PiZeros;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1Mass3Prong2orMorePiZeros;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SignalTracksChargeFraction;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1NumIsoTracks;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1NumIsoGammas;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1NumIsoCands;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SumPtIsoTracks;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SumPtIsoGammas;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1SumPtIso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1IsoRaw;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1MVAIsoRaw;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1NumberDensity;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1GenTauDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1GenTauDeltaEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1GenTauDeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1GenTauDeltaAlternatePt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1WithNeutralHadrCandsGenTauDeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1GenTauMatchedEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1GenTauMatchedPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1GenElectronMatchedEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1GenElectronMatchedPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1GenMuonMatchedEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1GenMuonMatchedPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1H3x3OverP;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2AlternatePt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2PtWithSeedTrack;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2PtWithMuonRef;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2PtWithoutMuonSegments;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2PtWithNeutralHadrCands;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2NumSignalGammas;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2NumSignalNeutralHads;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SeedTrackPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SeedTrackIpSignificance;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SeedTrackNhits;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SeedTrackChi2;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2Charge;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SignalTracksMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SignalTracksAndGammasMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SignalTracksMass1prong;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SignalTracksAndGammasMass1prong;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SignalTracksAndPiZerosMass1prong;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SignalTracksAndPiZerosMass3prong;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SignalTracksAndPiZerosMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2NumSignalPiZeros1prong;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2NumSignalPiZeros3prong;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SignalTracksMass3prong;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SignalTracksAndGammasMass3prong;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2Mass1Prong0PiZeros;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2Mass1Prong1PiZeros;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2Mass1Prong2orMorePiZeros;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2Mass3Prong0PiZeros;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2Mass3Prong1PiZeros;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2Mass3Prong2orMorePiZeros;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SignalTracksChargeFraction;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2NumIsoTracks;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2NumIsoGammas;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2NumIsoCands;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SumPtIsoTracks;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SumPtIsoGammas;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2SumPtIso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2IsoRaw;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1ElecVetoDiscr;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1MuonVetoDiscr;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet1IsoDiscr;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hTauJet1DMFDiscrVsProng;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2MVAIsoRaw;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2NumberDensity;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2GenTauDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2GenTauDeltaEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2GenTauDeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2GenTauDeltaAlternatePt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2WithNeutralHadrCandsGenTauDeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2GenTauMatchedEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2GenTauMatchedPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2GenElectronMatchedEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2GenElectronMatchedPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2GenMuonMatchedEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2GenMuonMatchedPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJet2H3x3OverP;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1TrackIso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1EcalIso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Ip;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1IpSignificance;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Iso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1PfIso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1PfIsoOverPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1PfTrackIso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1PfNeutralIso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1GenMuonDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1GenMuonDeltaEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1GenMuonDeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1CaloCompatibility;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1SegmentCompatibility;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1AntiPion;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hMuon1CaloCompatibilityVsSegmentCompatibility;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2TrackIso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2EcalIso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Ip;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2IpSignificance;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Iso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2PfIso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2PfIsoOverPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2PfTrackIso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2PfNeutralIso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2GenMuonDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2GenMuonDeltaEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2GenMuonDeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2CaloCompatibility;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2SegmentCompatibility;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2AntiPion;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hMuon2CaloCompatibilityVsSegmentCompatibility;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1PfIsoOverPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1TrackIso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1EcalIso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Ip;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1EoverP;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Classification;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1GenElectronDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1GenElectronDeltaEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1GenElectronDeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1EcalDriven;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1TrackerDriven;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1HoverEm;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1EESigmaIEtaIEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1EEDEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1EEDPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1EBSigmaIEtaIEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1EBDEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1EBDPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1EB2by5Over5by5;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1EB1by5Over5by5;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1MissingHits;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2PfIsoOverPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2TrackIso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2EcalIso;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Ip;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2EoverP;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Classification;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2GenElectronDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2GenElectronDeltaEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2GenElectronDeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2EcalDriven;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2TrackerDriven;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2HoverEm;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2EESigmaIEtaIEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2EEDEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2EEDPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2EBSigmaIEtaIEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2EBDEta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2EBDPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2EB2by5Over5by5;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2EB1by5Over5by5;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2MissingHits;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hNBJet_PassTCHP;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hNBJet_PassCSVL;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hNBJet_PassCSVM;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hNBJet_PassCSVT;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hBJetPt_PassTCHP;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hBJetEta_PassTCHP;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hBJetPt_PassCSVL;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hBJetEta_PassCSVL;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hBJetPt_PassCSVM;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hBJetEta_PassCSVM;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hBJetPt_PassCSVT;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hBJetEta_PassCSVT;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hBJetDiscrByTrackCountingHighEff;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hBJetDiscrByTrackCountingHighPur;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hBJetDiscrBySimpleSecondaryVertexHighEff;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hBJetDiscrByCombinedSecondaryVertexHighEff;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hBJetDiscrByCombinedSecondaryVertexMVA;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hCentralJetsLeadDiJetMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hCentralJetsBestWDiJetMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hLeadDiJetMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hLeadDiJetMt;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiJetMt;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hLeadingJetsMt;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1_Tau1DiJetDeltaPhi; 
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2_Tau2DiJetDeltaPhi; 
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1_Tau1DiJetDeltaPhi; 
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2_Tau2DiJetDeltaPhi; 
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1_Electron1DiJetDeltaPhi; 
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2_Electron1DiJetDeltaPhi; 
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1_Electron2DiJetDeltaPhi; 
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2_Electron2DiJetDeltaPhi; 
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Electron2_Electron1IsZee;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Electron2_Electron2IsZee;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Electron2_Electron1DiJetDeltaPhi; 
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Electron2_Electron2DiJetDeltaPhi; 
  ...
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hElectron1PtVsTau1Pt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1DeltaR;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1DeltaPtDivSumPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1DeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1OSLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1CosDphi;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hElectron1MetDeltaPhiVsElectron1Tau1CosDphi;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hElectron1PtVsTau2Pt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2DeltaR;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2DeltaPtDivSumPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2DeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2OSLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2CosDphi;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hElectron1MetDeltaPhiVsElectron1Tau2CosDphi;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hElectron2PtVsTau1Pt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1DeltaR;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1DeltaPtDivSumPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1DeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1OSLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1CosDphi;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hElectron2MetDeltaPhiVsElectron2Tau1CosDphi;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hElectron2PtVsTau2Pt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2DeltaR;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2DeltaPtDivSumPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2DeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2OSLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2CosDphi;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hElectron2MetDeltaPhiVsElectron2Tau2CosDphi;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1_Tau1MetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1_Tau1MetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2_Tau2MetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2_Tau2MetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1_Electron1MetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1_Electron2MetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2_Electron1MetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2_Electron2MetDeltaPhi;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiElectron_Electron1MetDeltaPhi;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiElectron_Electron2MetDeltaPhi;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1_Tau1MetMt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1_Tau1MetMt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2_Tau2MetMt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2_Tau2MetMt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1_Electron1MetMt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1_Electron2MetMt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2_Electron1MetMt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2_Electron2MetMt;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiElectron_Electron1MetMt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiElectron_Electron2MetMt;

/*
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hElectronPtVsMuonPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectronMuonDeltaR;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectronMuonDeltaPtDivSumPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectronMuonDeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectronMuonOSLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectronMuonCosDphi;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hElectronMetDeltaPhiVsElectronMuonCosDphi;
*/
  ...
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hElectron1PtVsElectron2Pt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Electron2DeltaR;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Electron2DeltaPtDivSumPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Electron2DeltaPt;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Electron2OSLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Electron2CosDphi;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hElectron1MetDeltaPhiVsElectron1Electron2CosDphi;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiTauNotReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiTauReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiTauNotReconstructableMassLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiTauReconstructableMassLS;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiElectronNotReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiElectronReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiElectronNotReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiElectronReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiElectronNotReconstructableMassLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiElectronReconstructableMassLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiElectronPZeta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiElectronPZetaVis;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hDiElectronZeta2D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hDiElectronZeta1D;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Tau1NotReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Tau1ReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Tau1NotReconstructableMassLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Tau1ReconstructableMassLS;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Tau2NotReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Tau2ReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Tau2NotReconstructableMassLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon1Tau2ReconstructableMassLS;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Tau1NotReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Tau1ReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Tau1NotReconstructableMassLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Tau1ReconstructableMassLS;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Tau2NotReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Tau2ReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Tau2NotReconstructableMassLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMuon2Tau2ReconstructableMassLS;
  ...
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1NotReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1ReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1NotReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1ReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1NotReconstructableMassLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1ReconstructableMassLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1PZeta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1PZetaVis;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hElectron1Tau1Zeta2D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1Zeta1D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2NotReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2ReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2NotReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2ReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2NotReconstructableMassLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2ReconstructableMassLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2PZeta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2PZetaVis;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hElectron1Tau2Zeta2D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2Zeta1D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1NotReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1ReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1NotReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1ReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1NotReconstructableMassLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1ReconstructableMassLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1PZeta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1PZetaVis;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hElectron2Tau1Zeta2D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1Zeta1D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2NotReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2ReconstructableMass;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2NotReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2ReconstructableMassOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2NotReconstructableMassLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2ReconstructableMassLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2PZeta;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2PZetaVis;
  std::map< unsigned int, std::map<unsigned int, TH2*>> _hElectron2Tau2Zeta2D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2Zeta1D;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMet;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hMetResolution;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau1_Electron1IsZee;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron1Tau2_Electron1IsZee;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau1_Electron2IsZee;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hElectron2Tau2_Electron2IsZee;
...
/* 
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJetSumPtIso_JetOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJetSumPtIso_JetLS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJetSumPtIso_SeedOS;
  std::map< unsigned int, std::map<unsigned int, TH1*>> _hTauJetSumPtIso_SeedLS;
*/
...
//  Handle< reco::CompositeCandidateCollection > _patDiTaus;
  ...
  Handle< reco::PFTauDiscriminator > _hpsTauDiscr;
  Handle< reco::GenMETCollection > genTrue;
  Handle<ValueMap<float> > puJetIdMVA;
  Handle<ValueMap<int> > puJetIdFlag;
  edm::Handle<edm::View<pat::Jet> > _jets;
