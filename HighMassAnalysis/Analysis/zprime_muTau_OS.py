...
process.analyzeHiMassTau.TriggerRequirements = cms.vstring('HLT_IsoMu24_eta2p1_v13','HLT_IsoMu24_v15')  # trigger path name
...
process.analyzeHiMassTau.Muon1Tau1CDFzeta2DCutValue = cms.double(-50.00)
