...
process.analyzeHiMassTau.Trigger1Requirements = cms.vstring('HLT_Ele27_WP80_v')  # trigger path name
process.analyzeHiMassTau.Trigger2Requirements = cms.vstring('HLT_Ele27_WP80_v')  # trigger path name
