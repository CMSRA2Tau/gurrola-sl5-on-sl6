...
process.analyzeHiMassTau.TriggerRequirements = cms.vstring('HLT_Ele27_WP80_v10')  # trigger path name
...
process.analyzeHiMassTau.Electron1Tau1DiscrByOSLSType = cms.string('OS')
...
process.analyzeHiMassTau.RecoElectron1Nmin = cms.int32(1)							
...
process.analyzeHiMassTau.Electron1Tau1CombinationsNmin = cms.int32(1)						 
...
process.analyzeHiMassTau.TopologicalSelectionSequence = cms.vstring('RecoElectron1Nmax',
                                                                    'RecoTau1Nmax',
                                                                    'RecoSecondLeadingJetNmin',
                                                                    'RecoBJetNmax',
                                                                    'SusyCombinationsNmin',
                                                                    'DiJetCombinationsNmax',
                                                                    'Electron1Tau1CombinationsNmax',
                                                                    'RecoTriggersNmin',
)
