...
process.analyzeHiMassTau.GenParticleSource = cms.untracked.InputTag('')
...
process.analyzeHiMassTau.RecoTau1DiscrByMinIsolation  = cms.untracked.string('byTightIsolationMVA3newDMwLT')
...
process.analyzeHiMassTau.RecoTau2DiscrByMinIsolation  = cms.untracked.string('byTightIsolationMVA3newDMwLT')
...
process.analyzeHiMassTau.RecoMuon2PtMinCut = cms.double(30.)
...
process.analyzeHiMassTau.RecoMetMaxCut = cms.double(99999.0) 					
process.analyzeHiMassTau.DoDiJetDiscrByDeltaR = cms.bool(True) 				
process.analyzeHiMassTau.DiJetDeltaRCut = cms.double(0.3)	 			
process.analyzeHiMassTau.DoDiJetDiscrByDeltaEta = cms.bool(False)
...
process.analyzeHiMassTau.DoDiJetDiscrByOSEta = cms.bool(False) 			
...
process.analyzeHiMassTau.Muon1Tau1DiscrByOSLSType = cms.string('OS')
process.analyzeHiMassTau.UseTauSeedTrackForMuon1Tau1DiscrByOSLS = cms.bool(False)
process.analyzeHiMassTau.DoMuon1Tau1DiscrByCosDphi = cms.bool(True)
...
process.analyzeHiMassTau.UseVectorSumOfMuon1Tau1ProductsAndMetMassReco = cms.bool(True)
...
process.analyzeHiMassTau.DoMuon1Tau1DiscrByCDFzeta2D = cms.bool(True)
process.analyzeHiMassTau.Muon1Tau1PZetaCutCoefficient = cms.double(1.0)
process.analyzeHiMassTau.Muon1Tau1PZetaVisCutCoefficient = cms.double(-3.1)
process.analyzeHiMassTau.Muon1Tau1CDFzeta2DCutValue = cms.double(-50.0)
...
process.analyzeHiMassTau.Muon1Tau2DiscrByOSLSType = cms.string('OS')
process.analyzeHiMassTau.UseTauSeedTrackForMuon1Tau2DiscrByOSLS = cms.bool(False)
process.analyzeHiMassTau.DoMuon1Tau2DiscrByCosDphi = cms.bool(True)
process.analyzeHiMassTau.Muon1Tau2CosDphiMaxCut = cms.double(2.0)
process.analyzeHiMassTau.Muon1Tau2CosDphiMinCut = cms.double(-0.95)
process.analyzeHiMassTau.DoDiscrByMuon1Tau2MassReco = cms.bool(False)
process.analyzeHiMassTau.UseVectorSumOfMuon1Tau2ProductsAndMetMassReco = cms.bool(True)
...
process.analyzeHiMassTau.DoMuon1Tau2DiscrByCDFzeta2D = cms.bool(True)
process.analyzeHiMassTau.Muon1Tau2PZetaCutCoefficient = cms.double(1.0)
process.analyzeHiMassTau.Muon1Tau2PZetaVisCutCoefficient = cms.double(-3.1)
process.analyzeHiMassTau.Muon1Tau2CDFzeta2DCutValue = cms.double(-50.0)
...
process.analyzeHiMassTau.Muon2Tau1DiscrByOSLSType = cms.string('OS')
process.analyzeHiMassTau.UseTauSeedTrackForMuon2Tau1DiscrByOSLS = cms.bool(False)
process.analyzeHiMassTau.DoMuon2Tau1DiscrByCosDphi = cms.bool(True)
...
process.analyzeHiMassTau.Muon2Tau2DiscrByOSLSType = cms.string('OS')
process.analyzeHiMassTau.UseTauSeedTrackForMuon2Tau2DiscrByOSLS = cms.bool(False)
process.analyzeHiMassTau.DoMuon2Tau2DiscrByCosDphi = cms.bool(True)
...
process.analyzeHiMassTau.UseVectorSumOfMuon2Tau2ProductsAndMetMassReco = cms.bool(True)
...
process.analyzeHiMassTau.Muon1MetMtMaxCut = cms.double(15.0)
