...
process.analyzeHiMassTau.RecoJet1PtCut                        = cms.double(50.0)                       
...
process.analyzeHiMassTau.RemoveJet1OverlapWithTau1s            = cms.bool(False)                        
...
process.analyzeHiMassTau.RecoJet2PtCut                        = cms.double(50.0)                       
...
process.analyzeHiMassTau.RemoveJet2OverlapWithTau1s            = cms.bool(False)                        
...
process.analyzeHiMassTau.RemoveCentralJetOverlapWithTau1s            = cms.bool(False)                        
...
process.analyzeHiMassTau.DiMuonCombinationsNmin = cms.int32(1)						 
...
process.analyzeHiMassTau.TopologicalSelectionSequence = cms.vstring('RecoMuon1Nmax',
                                                                    'RecoMuon2Nmax',
                                                                    'RecoJet1Nmax',
                                                                    'RecoSecondLeadingJetNmin',
                                                                    'RecoBJetNmax',
                                                                    'SusyCombinationsNmin',
                                                                    'DiMuonCombinationsNmax',
