...
process.analyzeHiMassTau.RecoTau1DiscrByIsolation = cms.untracked.string('byVLooseIsolationMVA3newDMwLT')	
...
process.analyzeHiMassTau.RecoTau1DiscrAgainstElectron = cms.untracked.string('againstElectronVLooseMVA5')
...
process.analyzeHiMassTau.RecoTau2DiscrByIsolation = cms.untracked.string('byVLooseIsolationMVA3newDMwLT')
...
process.analyzeHiMassTau.RecoTau2DiscrAgainstElectron = cms.untracked.string('againstElectronVLooseMVA5')
...
process.analyzeHiMassTau.JetBTaggingCut                  = cms.double(0.244)
...
process.analyzeHiMassTau.TriggerRequirements = cms.vstring('HLT_DiJet35_MJJ700_AllJets_DEta3p5_VBF_v1')  # trigger path name
...
process.analyzeHiMassTau.RecoMetCut = cms.double(150.0) 					
...
process.analyzeHiMassTau.RecoTriggersNmin = cms.int32(1)				# require event to pass >=X trigger paths defined above
