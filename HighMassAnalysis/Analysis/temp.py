...
process.analyzeHiMassTau.RecoTau1PtMinCut = cms.double(45.)					
process.analyzeHiMassTau.RecoTau1PtMaxCut = cms.double(9999.)					
process.analyzeHiMassTau.DoRecoTau1DiscrByLeadTrack = cms.bool(True) 				
process.analyzeHiMassTau.UseRecoTau1DiscrByLeadTrackFlag = cms.bool(False) 			
...
process.analyzeHiMassTau.RecoTau1DiscrByMaxIsolation = cms.untracked.string('byTightIsolationMVA3newDMwLT')	
...
process.analyzeHiMassTau.RecoTau1DiscrByProngType = cms.string('1hps')  		 	
...
process.analyzeHiMassTau.RemoveTau1OverlapWithMuon1s           = cms.bool(False)                        
...
process.analyzeHiMassTau.RecoTau2PtMinCut = cms.double(45.)
process.analyzeHiMassTau.RecoTau2PtMaxCut = cms.double(9999.)
process.analyzeHiMassTau.DoRecoTau2DiscrByLeadTrack = cms.bool(True)
process.analyzeHiMassTau.UseRecoTau2DiscrByLeadTrackFlag = cms.bool(False)
...
process.analyzeHiMassTau.RecoTau2DiscrByMaxIsolation = cms.untracked.string('byTightIsolationMVA3newDMwLT')	
...
process.analyzeHiMassTau.RecoTau2DiscrByProngType = cms.string('1hps')
...
process.analyzeHiMassTau.RemoveJet1OverlapWithMuon1s           = cms.bool(False)                        
...
process.analyzeHiMassTau.RemoveJet2OverlapWithMuon1s           = cms.bool(False)                        
...
process.analyzeHiMassTau.RemoveCentralJetOverlapWithMuon1s           = cms.bool(False)                        
...
process.analyzeHiMassTau.RemoveSecondLeadingJetOverlapWithMuon1s           = cms.bool(False)
...
process.analyzeHiMassTau.RecoBJetPtCut                        = cms.double(30.0)                           
process.analyzeHiMassTau.RemoveBJetOverlapWithMuon1s           = cms.bool(False)                            
...
process.analyzeHiMassTau.Trigger1Requirements = cms.vstring('HLT_DoubleMediumIsoPFTau35_Trk5_eta2p1_Prong1_v')  # trigger path name
process.analyzeHiMassTau.Trigger2Requirements = cms.vstring('HLT_DoubleMediumIsoPFTau35_Trk5_eta2p1_Prong1_v')  # trigger path name
...
process.analyzeHiMassTau.RecoMetMinCut = cms.double(30.0) 					
...
process.analyzeHiMassTau.DiJetMassMinCut = cms.double(250.0) 				
...
process.analyzeHiMassTau.DiTauDiscrByOSLSType = cms.string('OS')		 	
...
process.analyzeHiMassTau.RecoMuon1Nmin = cms.int32(0)							
...
process.analyzeHiMassTau.RecoTau2Nmin = cms.int32(2)							
process.analyzeHiMassTau.RecoTau2Nmax = cms.int32(2)							
process.analyzeHiMassTau.RecoJet1Nmin = cms.int32(0)							
process.analyzeHiMassTau.RecoJet1Nmax = cms.int32(10000)						        
process.analyzeHiMassTau.RecoJet2Nmin = cms.int32(0)							
...
process.analyzeHiMassTau.DiTauCombinationsNmin = cms.int32(1)						 
process.analyzeHiMassTau.DiTauCombinationsNmax = cms.int32(10000)						
process.analyzeHiMassTau.DiJetCombinationsNmin = cms.int32(0)						 
...
process.analyzeHiMassTau.TopologicalSelectionSequence = cms.vstring(
#                                                                    'RecoVertexNmax',
#                                                                    'RecoTriggers1Nmin',
#                                                                    'RecoTau1Nmax',
#                                                                    'RecoTau2Nmax',
...
process.analyzeHiMassTau.CalculatePdfSystematicUncertanties = cms.bool(True)				# if true, pdf systematic uncertanties will be calculated
process.analyzeHiMassTau.PdfWeightTags = cms.untracked.VInputTag("pdfWeights:cteq66")			# collection of weights for systematic uncertanties
