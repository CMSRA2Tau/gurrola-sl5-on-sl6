...
process.analyzeHiMassTau.RecoTau1DiscrAgainstElectron = cms.untracked.string('againstElectronTightMVA5')
...
process.analyzeHiMassTau.RecoTau2DiscrAgainstElectron = cms.untracked.string('againstElectronTightMVA5')
...
process.analyzeHiMassTau.ApplyJet1LooseID                     = cms.bool(False)
...
process.analyzeHiMassTau.ApplyCentralJetLooseID                     = cms.bool(False)
...
process.analyzeHiMassTau.ApplyJetLooseIDforMhtAndHt = cms.bool(False)
...
process.analyzeHiMassTau.RecoMetMinCut = cms.double(0.0) 					
process.analyzeHiMassTau.RecoMetMaxCut = cms.double(15.0) 					
...
process.analyzeHiMassTau.RecoJet1Nmin = cms.int32(1)							
process.analyzeHiMassTau.RecoJet1Nmax = cms.int32(10000)						        
process.analyzeHiMassTau.RecoJet2Nmin = cms.int32(1)							
...
process.analyzeHiMassTau.RecoBJetNmax = cms.int32(10000)						        # require event to have <=X "jets" passing specified cuts
...
process.analyzeHiMassTau.RecoTriggers2Nmin = cms.int32(0)				# require event to pass >=X trigger paths defined above

process.analyzeHiMassTau.TopologicalSelectionSequence = cms.vstring('RecoJet1Nmin',
                                                                    'RecoJet2Nmin',
)
