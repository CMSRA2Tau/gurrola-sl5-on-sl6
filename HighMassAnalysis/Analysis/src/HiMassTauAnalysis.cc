  ...
  scanPars(iConfig.getParameter<std::vector<std::string> >("ScanParameters"))
{
  ...
  _RecoTau1DiscrByMinIsolation = iConfig.getUntrackedParameter<string>("RecoTau1DiscrByMinIsolation");
  _RecoTau1DiscrByMaxIsolation = iConfig.getUntrackedParameter<string>("RecoTau1DiscrByMaxIsolation");
  ...
  _RecoTau2DiscrByMinIsolation = iConfig.getUntrackedParameter<string>("RecoTau2DiscrByMinIsolation");
  _RecoTau2DiscrByMaxIsolation = iConfig.getUntrackedParameter<string>("RecoTau2DiscrByMaxIsolation");
  ...
  _RecoMuon1IsoSumPtMinCutValue = iConfig.getParameter<double>("RecoMuon1IsoSumPtMinCutValue");
  _RecoMuon1IsoSumPtMaxCutValue = iConfig.getParameter<double>("RecoMuon1IsoSumPtMaxCutValue");
  ...
  _RecoMuon2IsoSumPtMinCutValue = iConfig.getParameter<double>("RecoMuon2IsoSumPtMinCutValue");
  _RecoMuon2IsoSumPtMaxCutValue = iConfig.getParameter<double>("RecoMuon2IsoSumPtMaxCutValue");
  ...
  _IsoValElecPFVInputTag = iConfig.getParameter< std::vector<edm::InputTag> >("IsoValElec");
  ...
  _RecoElectron1IsolationCone = iConfig.getParameter<string>("RecoElectron1IsolationCone");
  ...
  _RecoElectron2IsolationCone = iConfig.getParameter<string>("RecoElectron2IsolationCone");
  ...
  _ApplyJet1PileupID = iConfig.getParameter<bool>("ApplyJet1PileupID");
  ...
  _ApplyJet2PileupID = iConfig.getParameter<bool>("ApplyJet2PileupID");
  ...
  _ApplyCentralJetPileupID = iConfig.getParameter<bool>("ApplyCentralJetPileupID");
  ...
  _ApplyLeadingJetsPileupID = iConfig.getParameter<bool>("ApplyLeadingJetsPileupID");
  ...
  _Trigger1Requirements = iConfig.getParameter<std::vector<std::string> >("Trigger1Requirements");
  _Trigger2Requirements = iConfig.getParameter<std::vector<std::string> >("Trigger2Requirements");
  ...
  _RecoMetMinCut = iConfig.getParameter<double>("RecoMetMinCut");
  _RecoMetMaxCut = iConfig.getParameter<double>("RecoMetMaxCut");
  ...
  _DiTauCDFzeta2DMinCutValue = iConfig.getParameter<double>("DiTauCDFzeta2DMinCutValue");
  _DiTauCDFzeta2DMaxCutValue = iConfig.getParameter<double>("DiTauCDFzeta2DMaxCutValue");
  ...
  _DiMuonCDFzeta2DMinCutValue = iConfig.getParameter<double>("DiMuonCDFzeta2DMinCutValue");
  _DiMuonCDFzeta2DMaxCutValue = iConfig.getParameter<double>("DiMuonCDFzeta2DMaxCutValue");
  ...
  _DiElectronCDFzeta2DMinCutValue = iConfig.getParameter<double>("DiElectronCDFzeta2DMinCutValue");
  _DiElectronCDFzeta2DMaxCutValue = iConfig.getParameter<double>("DiElectronCDFzeta2DMaxCutValue");
  ...
  _Muon1Tau1CDFzeta2DMinCutValue = iConfig.getParameter<double>("Muon1Tau1CDFzeta2DMinCutValue");
  _Muon1Tau1CDFzeta2DMaxCutValue = iConfig.getParameter<double>("Muon1Tau1CDFzeta2DMaxCutValue");
  ...
  _Muon1Tau2CDFzeta2DMinCutValue = iConfig.getParameter<double>("Muon1Tau2CDFzeta2DMinCutValue");
  _Muon1Tau2CDFzeta2DMaxCutValue = iConfig.getParameter<double>("Muon1Tau2CDFzeta2DMaxCutValue");
  ...
  _Muon2Tau1CDFzeta2DMinCutValue = iConfig.getParameter<double>("Muon2Tau1CDFzeta2DMinCutValue");
  _Muon2Tau1CDFzeta2DMaxCutValue = iConfig.getParameter<double>("Muon2Tau1CDFzeta2DMaxCutValue");
  ...
  _Muon2Tau2CDFzeta2DMinCutValue = iConfig.getParameter<double>("Muon2Tau2CDFzeta2DMinCutValue");
  _Muon2Tau2CDFzeta2DMaxCutValue = iConfig.getParameter<double>("Muon2Tau2CDFzeta2DMaxCutValue");
  ...
  _Electron1Tau1CDFzeta2DMinCutValue = iConfig.getParameter<double>("Electron1Tau1CDFzeta2DMinCutValue");
  _Electron1Tau1CDFzeta2DMaxCutValue = iConfig.getParameter<double>("Electron1Tau1CDFzeta2DMaxCutValue");
  ...
  _Electron1Tau2CDFzeta2DMinCutValue = iConfig.getParameter<double>("Electron1Tau2CDFzeta2DMinCutValue");
  _Electron1Tau2CDFzeta2DMaxCutValue = iConfig.getParameter<double>("Electron1Tau2CDFzeta2DMaxCutValue");
  ...
  _Electron2Tau1CDFzeta2DMinCutValue = iConfig.getParameter<double>("Electron2Tau1CDFzeta2DMinCutValue");
  _Electron2Tau1CDFzeta2DMaxCutValue = iConfig.getParameter<double>("Electron2Tau1CDFzeta2DMaxCutValue");
  ...
  _Electron2Tau2CDFzeta2DMinCutValue = iConfig.getParameter<double>("Electron2Tau2CDFzeta2DMinCutValue");
  _Electron2Tau2CDFzeta2DMaxCutValue = iConfig.getParameter<double>("Electron2Tau2CDFzeta2DMaxCutValue");
  ...
  _Electron1Muon1CDFzeta2DMinCutValue = iConfig.getParameter<double>("Electron1Muon1CDFzeta2DMinCutValue");
  _Electron1Muon1CDFzeta2DMaxCutValue = iConfig.getParameter<double>("Electron1Muon1CDFzeta2DMaxCutValue");
  ...
  _Electron1Muon2CDFzeta2DMinCutValue = iConfig.getParameter<double>("Electron1Muon2CDFzeta2DMinCutValue");
  _Electron1Muon2CDFzeta2DMaxCutValue = iConfig.getParameter<double>("Electron1Muon2CDFzeta2DMaxCutValue");
  ...
  _Electron2Muon1CDFzeta2DMinCutValue = iConfig.getParameter<double>("Electron2Muon1CDFzeta2DMinCutValue");
  _Electron2Muon1CDFzeta2DMaxCutValue = iConfig.getParameter<double>("Electron2Muon1CDFzeta2DMaxCutValue");
  ...
  _Electron2Muon2CDFzeta2DMinCutValue = iConfig.getParameter<double>("Electron2Muon2CDFzeta2DMinCutValue");
  _Electron2Muon2CDFzeta2DMaxCutValue = iConfig.getParameter<double>("Electron2Muon2CDFzeta2DMaxCutValue");
  ...
  _ApplyJetLooseIDforMhtAndHt = iConfig.getParameter<bool>("ApplyJetLooseIDforMhtAndHt");
  _ApplyJetPileupIDforMhtAndHt = iConfig.getParameter<bool>("ApplyJetPileupIDforMhtAndHt");
  ...
  _DoSUSYDiscrByLeadDiJetDeltaPhi = iConfig.getParameter<bool>("DoSUSYDiscrByLeadDiJetDeltaPhi");
  _LeadDiJetMinDeltaPhiCut = iConfig.getParameter<double>("LeadDiJetMinDeltaPhiCut");
  _LeadDiJetMaxDeltaPhiCut = iConfig.getParameter<double>("LeadDiJetMaxDeltaPhiCut");
  _DoSUSYDiscrByLeadDiJetOSEta = iConfig.getParameter<bool>("DoSUSYDiscrByLeadDiJetOSEta");
...
//  _DoProduceNtuple = true;
  ...
  _RecoTriggers1Nmin = iConfig.getParameter<int>("RecoTriggers1Nmin");
  _RecoTriggers2Nmin = iConfig.getParameter<int>("RecoTriggers2Nmin");
  ...
  _RecoMuon1MetTopologyNmin = iConfig.getParameter<int>("RecoMuon1MetTopologyNmin");
  _RecoMuon1MetTopologyNmax = iConfig.getParameter<int>("RecoMuon1MetTopologyNmax");
  _RecoMuon2MetTopologyNmin = iConfig.getParameter<int>("RecoMuon2MetTopologyNmin");
  _RecoMuon2MetTopologyNmax = iConfig.getParameter<int>("RecoMuon2MetTopologyNmax");
  _RecoElectron1MetTopologyNmin = iConfig.getParameter<int>("RecoElectron1MetTopologyNmin");
  _RecoElectron1MetTopologyNmax = iConfig.getParameter<int>("RecoElectron1MetTopologyNmax");
  _RecoElectron2MetTopologyNmin = iConfig.getParameter<int>("RecoElectron2MetTopologyNmin");
  _RecoElectron2MetTopologyNmax = iConfig.getParameter<int>("RecoElectron2MetTopologyNmax");
  _RecoTau1MetTopologyNmin = iConfig.getParameter<int>("RecoTau1MetTopologyNmin");
  _RecoTau1MetTopologyNmax = iConfig.getParameter<int>("RecoTau1MetTopologyNmax");
  _RecoTau2MetTopologyNmin = iConfig.getParameter<int>("RecoTau2MetTopologyNmin");
  _RecoTau2MetTopologyNmax = iConfig.getParameter<int>("RecoTau2MetTopologyNmax");
...
void HiMassTauAnalysis::analyze(const Event& iEvent, const EventSetup& iSetup) {
  ...
  // set the trigger weight to 1 ... not correcting at this point for trigger scale factors  
  trig_weight = 1;
...
/*
          std::cout << "****************************************************************************" << std::endl;
          std::cout << "MET = " << theMETVector.pt() << std::endl;
          int theNumberOfJets = 0;
          std::cout << "----- Before Jet Requirements -----" << std::endl;
          for ( pat::JetCollection::const_iterator patJet = _patJets->begin();patJet != _patJets->end(); ++patJet ) {
            theNumberOfJets++;
            dumpRecoJet1Info((*patJet),theNumberOfJets-1);
          }
          ...
          for ( pat::TauCollection::const_iterator patTau = _patTaus->begin(); patTau != _patTaus->end(); ++patTau ) {
            ...
            std::cout << "Tau Eta = " << patTau->eta() << std::endl;
            std::cout << "Tau Eta = " << patTau->phi() << std::endl;
            std::cout << "Tau Pt  = " << patTau->pt() << std::endl;
          }

          theNumberOfJets = 0;
          std::cout << "----- After Jet Requirements -----" << std::endl;
          for ( pat::JetCollection::const_iterator patJet = _patJets->begin();patJet != _patJets->end(); ++patJet ) {
            theNumberOfJets++;
...
void HiMassTauAnalysis::getEventFlags(const Event& iEvent) {
  ...
  if(passRecoTrigger1Cuts(iEvent)) {nTriggersSatisfied++;}
  ...
  for ( pat::JetCollection::const_iterator patJet = _patJets->begin(); 	patJet != _patJets->end(); ++patJet ) {
    ...
    if( (smearedJetPtEtaPhiMVector.at(theNumberOfJets-1).pt() > _JetPtForMhtAndHt) && 
      ...
      if(_ApplyJetLooseIDforMhtAndHt) {
        if(passedLooseJetID((*patJet),theNumberOfJets-1)) {
          if(_ApplyJetPileupIDforMhtAndHt) {
            if(passedPileupJetID(theNumberOfJets-1)) {
  ...
  if(passSusyTopologyCuts(theLeadingJetIndex - 1,theSecondLeadingJetIndex - 1)) {nGoodSusyCombinations++;}
  ...
  for ( pat::MuonCollection::const_iterator patMuon = _patMuons->begin(); patMuon != _patMuons->end(); ++patMuon ) {
    theNumberOfMuons++;
    if (!passRecoMuon1Cuts((*patMuon),theNumberOfMuons-1)) continue;
    if (!passRecoMuon1MetTopologyCuts((*patMuon),theNumberOfMuons-1)) continue;
    nGoodCandidatesMuon1++;
  }
  theNumberOfMuons = 0;
  for ( pat::MuonCollection::const_iterator patMuon = _patMuons->begin(); patMuon != _patMuons->end(); ++patMuon ) {
    theNumberOfMuons++;
    if (!passRecoMuon2Cuts((*patMuon),theNumberOfMuons-1)) continue;
    if (!passRecoMuon2MetTopologyCuts((*patMuon),theNumberOfMuons-1)) continue;
    nGoodCandidatesMuon2++;
  }
  theNumberOfElectrons = 0;
  for ( pat::ElectronCollection::const_iterator patElectron = _patElectrons->begin(); patElectron != _patElectrons->end(); ++patElectron ) {
    theNumberOfElectrons++;
    if (!passRecoElectron1Cuts((*patElectron),theNumberOfElectrons-1)) continue;
    if (!passRecoElectron1MetTopologyCuts((*patElectron),theNumberOfElectrons-1)) continue;
    nGoodCandidatesElectron1++;
  }
  theNumberOfElectrons = 0;
  for ( pat::ElectronCollection::const_iterator patElectron = _patElectrons->begin(); patElectron != _patElectrons->end(); ++patElectron ) {
    theNumberOfElectrons++;
    if (!passRecoElectron2Cuts((*patElectron),theNumberOfElectrons-1)) continue;
    if (!passRecoElectron2MetTopologyCuts((*patElectron),theNumberOfElectrons-1)) continue;
    nGoodCandidatesElectron2++;
  }
  theNumberOfTaus = 0;
  for ( pat::TauCollection::const_iterator patTau = _patTaus->begin(); patTau != _patTaus->end(); ++patTau ) {
    theNumberOfTaus++;
    if (!passRecoTau1Cuts((*patTau),theNumberOfTaus-1)) continue;
    if (!passRecoTau1MetTopologyCuts((*patTau),theNumberOfTaus-1)) continue;
    nGoodCandidatesTau1++;
  }
  theNumberOfTaus = 0;
  for ( pat::TauCollection::const_iterator patTau = _patTaus->begin(); patTau != _patTaus->end(); ++patTau ) {
    theNumberOfTaus++;
    if (!passRecoTau2Cuts((*patTau),theNumberOfTaus-1)) continue;
    if (!passRecoTau2MetTopologyCuts((*patTau),theNumberOfTaus-1)) continue;
    nGoodCandidatesTau2++;
  }
  ...
  if(passRecoTrigger2Cuts(iEvent)) {nTriggersSatisfied++;}
...
bool HiMassTauAnalysis::passRecoTrigger1Cuts(const Event& iEvent) {
  ...
  for(unsigned int nTrig = 0; nTrig < _triggerResults->size(); ++nTrig) {
    ...
    for(std::vector<std::string>::const_iterator TheTriggerPath = _Trigger1Requirements.begin(); TheTriggerPath != _Trigger1Requirements.end(); ++TheTriggerPath ) {
      if( (trigName.find(*TheTriggerPath) != string::npos) && ((*_triggerResults)[nTrig].accept()) ) {return true;}
    }
  }
/*
  const edm::TriggerNames & TheTriggerNames = iEvent.triggerNames(*_triggerResults);
...
// -------------Apply Trigger Requirements
bool HiMassTauAnalysis::passRecoTrigger2Cuts(const Event& iEvent) {
  const edm::TriggerNames & TheTriggerNames = iEvent.triggerNames(*_triggerResults);
  for(unsigned int nTrig = 0; nTrig < _triggerResults->size(); ++nTrig) {
    string trigName = TheTriggerNames.triggerName(nTrig);
    for(std::vector<std::string>::const_iterator TheTriggerPath = _Trigger2Requirements.begin(); TheTriggerPath != _Trigger2Requirements.end(); ++TheTriggerPath ) {
      if( (trigName.find(*TheTriggerPath) != string::npos) && ((*_triggerResults)[nTrig].accept()) ) {return true;}
    }
  }
/*
  const edm::TriggerNames & TheTriggerNames = iEvent.triggerNames(*_triggerResults);
  for(std::vector<std::string>::const_iterator TheTriggerPath = _Trigger2Requirements.begin();
      TheTriggerPath != _Trigger2Requirements.end(); ++TheTriggerPath ) {
    unsigned int index = TheTriggerNames.triggerIndex(*TheTriggerPath);
    if(index < TheTriggerNames.size()) {if(_triggerResults->accept(index)) {return true;}}
    else {
      //      std::cout << "### HiMassTauAnalysis - CONFIGURATION ERROR:  Specified trigger " << (*TheTriggerPath) << " is not found/defined!!!!" << std::endl;
...
bool HiMassTauAnalysis::passRecoTau1Cuts(const pat::Tau& patTau,int nobj) {
  ...
  if (_DoRecoTau1DiscrByLeadTrack) {
    if (_UseRecoTau1DiscrByLeadTrackFlag) { if ( (patTau.tauID(_RecoTau1DiscrByLeadTrack.data()) < 0.5) ) {return false;} }
      ...
      if (patTau.isCaloTau()) { if( (!(patTau.leadTrack().isNonnull())) || (patTau.leadTrack()->pt() < _RecoTau1LeadTrackThreshold) ) {return false;} }
        ...
        if( (!(patTau.leadPFChargedHadrCand().isNonnull())) || (patTau.leadPFChargedHadrCand()->pt() < _RecoTau1LeadTrackThreshold) ) {return false;} 
      }
    }
  }
  // ----"eVeto" - Lead track minimimum hits requirement && H3x3/LTpt (Andres Florez's eVeto)
  ...
  if (_DoRecoTau1DiscrByIsolation) {    
    if (_UseRecoTau1DiscrByIsolationFlag) {
      if ( (patTau.tauID(_RecoTau1DiscrByMaxIsolation.data()) < 0.5) ) {return false;}
      if(_RecoTau1DiscrByMinIsolation == "ZERO") { }
      else {
        if ( (patTau.tauID(_RecoTau1DiscrByMinIsolation.data()) > 0.5) ) {return false;}
      }
    } else {
...
bool HiMassTauAnalysis::passRecoTau2Cuts(const pat::Tau& patTau,int nobj) {
  ...
  if (_DoRecoTau2DiscrByLeadTrack) {
    if (_UseRecoTau2DiscrByLeadTrackFlag) { if ( (patTau.tauID(_RecoTau2DiscrByLeadTrack.data()) < 0.5) ) {return false;} }
      ...
      if (patTau.isCaloTau()) { if( (!(patTau.leadTrack().isNonnull())) || (patTau.leadTrack()->pt() < _RecoTau2LeadTrackThreshold) ) {return false;} }
        ...
        if( (!(patTau.leadPFChargedHadrCand().isNonnull())) || (patTau.leadPFChargedHadrCand()->pt() < _RecoTau2LeadTrackThreshold) ) {return false;} 
      }
    }
  }
  ...
  if (_DoRecoTau2DiscrByIsolation) {    
    if (_UseRecoTau2DiscrByIsolationFlag) {
      if ( (patTau.tauID(_RecoTau2DiscrByMaxIsolation.data()) < 0.5) ) {return false;}
      if(_RecoTau2DiscrByMinIsolation == "ZERO") { }
      else {
        if ( (patTau.tauID(_RecoTau2DiscrByMinIsolation.data()) > 0.5) ) {return false;}
      }
    } else {
...
bool HiMassTauAnalysis::passRecoMuon1Cuts(const pat::Muon& patMuon,int nobj) {
  ...
  if (_DoRecoMuon1DiscrByIsolation) {
    if( ((patMuon.pfIsolationR04().sumChargedHadronPt + max(0.,patMuon.pfIsolationR04().sumNeutralHadronEt + patMuon.pfIsolationR04().sumPhotonEt - (0.5 * patMuon.pfIsolationR04().sumPUPt))) / smearedMuonPtEtaPhiMVector.at(nobj).pt()) >= _RecoMuon1IsoSumPtMaxCutValue  ) {return false;}
    if( ((patMuon.pfIsolationR04().sumChargedHadronPt + max(0.,patMuon.pfIsolationR04().sumNeutralHadronEt + patMuon.pfIsolationR04().sumPhotonEt - (0.5 * patMuon.pfIsolationR04().sumPUPt))) / smearedMuonPtEtaPhiMVector.at(nobj).pt()) <  _RecoMuon1IsoSumPtMinCutValue  ) {return false;}
  }
...
bool HiMassTauAnalysis::passRecoMuon2Cuts(const pat::Muon& patMuon,int nobj) {
  ...
  if (_DoRecoMuon2DiscrByIsolation) {
    if( ((patMuon.pfIsolationR04().sumChargedHadronPt + max(0.,patMuon.pfIsolationR04().sumNeutralHadronEt + patMuon.pfIsolationR04().sumPhotonEt - (0.5 * patMuon.pfIsolationR04().sumPUPt))) / smearedMuonPtEtaPhiMVector.at(nobj).pt()) >= _RecoMuon2IsoSumPtMaxCutValue  ) {return false;}
    if( ((patMuon.pfIsolationR04().sumChargedHadronPt + max(0.,patMuon.pfIsolationR04().sumNeutralHadronEt + patMuon.pfIsolationR04().sumPhotonEt - (0.5 * patMuon.pfIsolationR04().sumPUPt))) / smearedMuonPtEtaPhiMVector.at(nobj).pt()) <  _RecoMuon2IsoSumPtMinCutValue  ) {return false;}
  }
...
bool HiMassTauAnalysis::passRecoElectron1Cuts(const pat::Electron& patElectron,int nobj) {
  ...
  double relIsorho = 0;
  if(isData) {
    if (_RecoElectron1IsolationCone == "dR03") {
    ...
    } else if(_RecoElectron1IsolationCone == "dR04") {
      AEff03 = ElectronEffectiveArea::GetElectronEffectiveArea(ElectronEffectiveArea::kEleGammaAndNeutralHadronIso04, theHeepElec.scEta(), ElectronEffectiveArea::kEleEAData2012);
    } else {
      AEff03 = ElectronEffectiveArea::GetElectronEffectiveArea(ElectronEffectiveArea::kEleGammaAndNeutralHadronIso04, theHeepElec.scEta(), ElectronEffectiveArea::kEleEAData2012);
    }
  } else {
    if (_RecoElectron1IsolationCone == "dR03") {
      ...
      AEff03 = ElectronEffectiveArea::GetElectronEffectiveArea(ElectronEffectiveArea::kEleGammaAndNeutralHadronIso04, theHeepElec.scEta(), ElectronEffectiveArea::kEleEAFall11MC);
    } else {
      AEff03 = ElectronEffectiveArea::GetElectronEffectiveArea(ElectronEffectiveArea::kEleGammaAndNeutralHadronIso04, theHeepElec.scEta(), ElectronEffectiveArea::kEleEAFall11MC);
    }
  }
/*
  ...
  if(_CalculateRecoElectron1IsolationUsingIsoDeposits) {
    if (_RecoElectron1IsolationCone == "dR03") {
      relIsorho = ( patElectron.isoDeposit(pat::PfChargedHadronIso)->depositAndCountWithin(0.3, vetos_ch).first + 
      ...
      relIsorho = ( patElectron.isoDeposit(pat::PfChargedHadronIso)->depositAndCountWithin(0.4, vetos_ch).first + 
			         max(0.0, patElectron.isoDeposit(pat::PfNeutralHadronIso)->depositAndCountWithin(0.4, vetos_nh).first + 
				     patElectron.isoDeposit(pat::PfGammaIso)->depositAndCountWithin(0.4, vetos_ph).first - 
				     rhoIso*AEff03) )/ smearedElectronPtEtaPhiMVector.at(nobj).pt();
    } else {
      relIsorho = ( patElectron.isoDeposit(pat::PfChargedHadronIso)->depositAndCountWithin(0.4, vetos_ch).first + 
			         max(0.0, patElectron.isoDeposit(pat::PfNeutralHadronIso)->depositAndCountWithin(0.4, vetos_nh).first + 
    ...
    relIsorho = ( patElectron.chargedHadronIso() + max(0.0, patElectron.neutralHadronIso() + patElectron.photonIso() - rhoIso*AEff03) ) / smearedElectronPtEtaPhiMVector.at(nobj).pt();
  }
*/
  unsigned nele=gsfElectronH->size();
  for(unsigned iele=0; iele<nele;++iele) {
    reco::GsfElectronRef myElectronRef(gsfElectronH,iele);
    if(!myElectronRef.isNonnull()) continue;
    if(reco::deltaR(myElectronRef->eta(), myElectronRef->phi(), patElectron.eta(), patElectron.phi()) < 0.01) {
      relIsorho = ( (*_elecIsoValPFIdDr04[0])[myElectronRef] + max(0.0, (*_elecIsoValPFIdDr04[1])[myElectronRef] + 
                  (*_elecIsoValPFIdDr04[2])[myElectronRef] - rhoIso*AEff03) ) / smearedElectronPtEtaPhiMVector.at(nobj).pt();
    }
  }
//  std::cout << relIsorho << std::endl;
  ...
  if (_DoRecoElectron1DiscrByEoverP) {
//    if((patElectron.eSuperClusterOverP()>_RecoElectron1EoverPMax) || (patElectron.eSuperClusterOverP()<_RecoElectron1EoverPMin)) {return false;}
    if( fabs((1.0 / patElectron.ecalEnergy()) - (1.0 / patElectron.trackMomentumAtVtx().R())) < _RecoElectron1EoverPMin ) {return false;}
    if( fabs((1.0 / patElectron.ecalEnergy()) - (1.0 / patElectron.trackMomentumAtVtx().R())) > _RecoElectron1EoverPMax ) {return false;}
  }
...
bool HiMassTauAnalysis::passRecoElectron2Cuts(const pat::Electron& patElectron,int nobj) {
  ...
  double relIsorho = 0;
  if(isData) {
    if (_RecoElectron2IsolationCone == "dR03") {
      AEff03 = ElectronEffectiveArea::GetElectronEffectiveArea(ElectronEffectiveArea::kEleGammaAndNeutralHadronIso03, theHeepElec.scEta(), ElectronEffectiveArea::kEleEAData2012);
    } else if(_RecoElectron2IsolationCone == "dR04") {
      AEff03 = ElectronEffectiveArea::GetElectronEffectiveArea(ElectronEffectiveArea::kEleGammaAndNeutralHadronIso04, theHeepElec.scEta(), ElectronEffectiveArea::kEleEAData2012);
    } else {
      AEff03 = ElectronEffectiveArea::GetElectronEffectiveArea(ElectronEffectiveArea::kEleGammaAndNeutralHadronIso04, theHeepElec.scEta(), ElectronEffectiveArea::kEleEAData2012);
    }
...
/*
  ...
  if(_CalculateRecoElectron2IsolationUsingIsoDeposits) {
    if (_RecoElectron2IsolationCone == "dR03") {
      relIsorho = ( patElectron.isoDeposit(pat::PfChargedHadronIso)->depositAndCountWithin(0.3, vetos_ch).first + 
			         max(0.0, patElectron.isoDeposit(pat::PfNeutralHadronIso)->depositAndCountWithin(0.3, vetos_nh).first + 
				     patElectron.isoDeposit(pat::PfGammaIso)->depositAndCountWithin(0.3, vetos_ph).first - 
...
*/
  ...
  // ----E over p requirement
  if (_DoRecoElectron2DiscrByEoverP) {
//    if((patElectron.eSuperClusterOverP()>_RecoElectron2EoverPMax) || (patElectron.eSuperClusterOverP()<_RecoElectron2EoverPMin)) {return false;}
    if( fabs((1.0 / patElectron.ecalEnergy()) - (1.0 / patElectron.trackMomentumAtVtx().R())) < _RecoElectron2EoverPMin ) {return false;}
    if( fabs((1.0 / patElectron.ecalEnergy()) - (1.0 / patElectron.trackMomentumAtVtx().R())) > _RecoElectron2EoverPMax ) {return false;}
  }
  // ----Electromagnetic energy fraction requirement
...
bool HiMassTauAnalysis::passRecoJet1Cuts(const pat::Jet& patJet,int nobj) {
  ...
  if (_ApplyJet1LooseID) {
    if (!passedLooseJetID(patJet,nobj)) {return false;}
  }
  if (_ApplyJet1PileupID) {
    if (!passedPileupJetID(nobj)) {return false;}
  }
  // ----anti-overlap requirements
...
bool HiMassTauAnalysis::passMuon1Tau1TopologyCuts(const pat::Tau& patTau, int nobjT, const pat::Muon& patMuon, int nobjM) {
  ...
  if (_DoMuon1Tau1DiscrByCDFzeta2D) {
    if( ((_Muon1Tau1PZetaCutCoefficient * CalculatePZeta(patTau,nobjT,patMuon,nobjM)) + 
         (_Muon1Tau1PZetaVisCutCoefficient * CalculatePZetaVis(patTau,nobjT,patMuon,nobjM))) < _Muon1Tau1CDFzeta2DMinCutValue )
      {return false;}
    if( ((_Muon1Tau1PZetaCutCoefficient * CalculatePZeta(patTau,nobjT,patMuon,nobjM)) + 
         (_Muon1Tau1PZetaVisCutCoefficient * CalculatePZetaVis(patTau,nobjT,patMuon,nobjM))) > _Muon1Tau1CDFzeta2DMaxCutValue )
      {return false;}
  }
...
bool HiMassTauAnalysis::passRecoMuon1MetTopologyCuts(const pat::Muon& patMuon, int nobjM) {
...
bool HiMassTauAnalysis::passRecoTau1MetTopologyCuts(const pat::Tau& patTau, int nobjT) {
...
bool HiMassTauAnalysis::passMuon1Tau2TopologyCuts(const pat::Tau& patTau, int nobjT, const pat::Muon& patMuon, int nobjM) {
  ...
  if (_DoMuon1Tau2DiscrByCDFzeta2D) {
    if( ((_Muon1Tau2PZetaCutCoefficient * CalculatePZeta(patTau,nobjT,patMuon,nobjM)) + 
         (_Muon1Tau2PZetaVisCutCoefficient * CalculatePZetaVis(patTau,nobjT,patMuon,nobjM))) < _Muon1Tau2CDFzeta2DMinCutValue )
      {return false;}
    if( ((_Muon1Tau2PZetaCutCoefficient * CalculatePZeta(patTau,nobjT,patMuon,nobjM)) + 
         (_Muon1Tau2PZetaVisCutCoefficient * CalculatePZetaVis(patTau,nobjT,patMuon,nobjM))) > _Muon1Tau2CDFzeta2DMaxCutValue )
      {return false;}
  }
  // ----Missing transverse energy requirement
...
bool HiMassTauAnalysis::passRecoTau2MetTopologyCuts(const pat::Tau& patTau, int nobjT) {
...
bool HiMassTauAnalysis::passMuon2Tau1TopologyCuts(const pat::Tau& patTau, int nobjT, const pat::Muon& patMuon, int nobjM) {
  ...
  if (_DoMuon2Tau1DiscrByCDFzeta2D) {
    if( ((_Muon2Tau1PZetaCutCoefficient * CalculatePZeta(patTau,nobjT,patMuon,nobjM)) + 
         (_Muon2Tau1PZetaVisCutCoefficient * CalculatePZetaVis(patTau,nobjT,patMuon,nobjM))) < _Muon2Tau1CDFzeta2DMinCutValue )
      {return false;}
    if( ((_Muon2Tau1PZetaCutCoefficient * CalculatePZeta(patTau,nobjT,patMuon,nobjM)) + 
         (_Muon2Tau1PZetaVisCutCoefficient * CalculatePZetaVis(patTau,nobjT,patMuon,nobjM))) > _Muon2Tau1CDFzeta2DMaxCutValue )
      {return false;}
  }
  // ----Missing transverse energy requirement
...
bool HiMassTauAnalysis::passRecoMuon2MetTopologyCuts(const pat::Muon& patMuon, int nobjM) {
...
bool HiMassTauAnalysis::passMuon2Tau2TopologyCuts(const pat::Tau& patTau, int nobjT, const pat::Muon& patMuon, int nobjM) {
  ...
  if (_DoMuon2Tau2DiscrByCDFzeta2D) {
    if( ((_Muon2Tau2PZetaCutCoefficient * CalculatePZeta(patTau,nobjT,patMuon,nobjM)) + 
         (_Muon2Tau2PZetaVisCutCoefficient * CalculatePZetaVis(patTau,nobjT,patMuon,nobjM))) < _Muon2Tau2CDFzeta2DMinCutValue )
      {return false;}
    if( ((_Muon2Tau2PZetaCutCoefficient * CalculatePZeta(patTau,nobjT,patMuon,nobjM)) + 
         (_Muon2Tau2PZetaVisCutCoefficient * CalculatePZetaVis(patTau,nobjT,patMuon,nobjM))) > _Muon2Tau2CDFzeta2DMaxCutValue )
      {return false;}
  }
  // ----Missing transverse energy requirement
...
bool HiMassTauAnalysis::passElectron1Tau1TopologyCuts(const pat::Tau& patTau, int nobjT, const pat::Electron& patElectron, int nobjE) {
  ...
  if (_DoElectron1Tau1DiscrByCDFzeta2D) {
    if( ((_Electron1Tau1PZetaCutCoefficient * CalculatePZeta(patTau,nobjT,patElectron,nobjE)) + 
         (_Electron1Tau1PZetaVisCutCoefficient * CalculatePZetaVis(patTau,nobjT,patElectron,nobjE))) < _Electron1Tau1CDFzeta2DMinCutValue )
      {return false;}
    if( ((_Electron1Tau1PZetaCutCoefficient * CalculatePZeta(patTau,nobjT,patElectron,nobjE)) + 
         (_Electron1Tau1PZetaVisCutCoefficient * CalculatePZetaVis(patTau,nobjT,patElectron,nobjE))) > _Electron1Tau1CDFzeta2DMaxCutValue )
      {return false;}
  }
  // ----Missing transverse energy requirement
...
bool HiMassTauAnalysis::passRecoElectron1MetTopologyCuts(const pat::Electron& patElectron, int nobjE) {
...
bool HiMassTauAnalysis::passElectron1Tau2TopologyCuts(const pat::Tau& patTau, int nobjT, const pat::Electron& patElectron, int nobjE) {
  ...
  if (_DoElectron1Tau2DiscrByCDFzeta2D) {
    if( ((_Electron1Tau2PZetaCutCoefficient * CalculatePZeta(patTau,nobjT,patElectron,nobjE)) + 
         (_Electron1Tau2PZetaVisCutCoefficient * CalculatePZetaVis(patTau,nobjT,patElectron,nobjE))) < _Electron1Tau2CDFzeta2DMinCutValue )
      {return false;}
    if( ((_Electron1Tau2PZetaCutCoefficient * CalculatePZeta(patTau,nobjT,patElectron,nobjE)) + 
         (_Electron1Tau2PZetaVisCutCoefficient * CalculatePZetaVis(patTau,nobjT,patElectron,nobjE))) > _Electron1Tau2CDFzeta2DMaxCutValue )
      {return false;}
  }
  // ----Missing transverse energy requirement
...
bool HiMassTauAnalysis::passElectron2Tau1TopologyCuts(const pat::Tau& patTau, int nobjT, const pat::Electron& patElectron, int nobjE) {
  ...
  if (_DoElectron2Tau1DiscrByCDFzeta2D) {
    if( ((_Electron2Tau1PZetaCutCoefficient * CalculatePZeta(patTau,nobjT,patElectron,nobjE)) + 
         (_Electron2Tau1PZetaVisCutCoefficient * CalculatePZetaVis(patTau,nobjT,patElectron,nobjE))) < _Electron2Tau1CDFzeta2DMinCutValue )
      {return false;}
    if( ((_Electron2Tau1PZetaCutCoefficient * CalculatePZeta(patTau,nobjT,patElectron,nobjE)) + 
         (_Electron2Tau1PZetaVisCutCoefficient * CalculatePZetaVis(patTau,nobjT,patElectron,nobjE))) > _Electron2Tau1CDFzeta2DMaxCutValue )
      {return false;}
  }
  // ----Missing transverse energy requirement
...
bool HiMassTauAnalysis::passRecoElectron2MetTopologyCuts(const pat::Electron& patElectron, int nobjE) {
...
bool HiMassTauAnalysis::passElectron2Tau2TopologyCuts(const pat::Tau& patTau, int nobjT, const pat::Electron& patElectron, int nobjE) {
  ...
  if (_DoElectron2Tau2DiscrByCDFzeta2D) {
    if( ((_Electron2Tau2PZetaCutCoefficient * CalculatePZeta(patTau,nobjT,patElectron,nobjE)) + 
         (_Electron2Tau2PZetaVisCutCoefficient * CalculatePZetaVis(patTau,nobjT,patElectron,nobjE))) < _Electron2Tau2CDFzeta2DMinCutValue )
      {return false;}
    if( ((_Electron2Tau2PZetaCutCoefficient * CalculatePZeta(patTau,nobjT,patElectron,nobjE)) + 
         (_Electron2Tau2PZetaVisCutCoefficient * CalculatePZetaVis(patTau,nobjT,patElectron,nobjE))) > _Electron2Tau2CDFzeta2DMaxCutValue )
      {return false;}
  }
  // ----Missing transverse energy requirement
...
bool HiMassTauAnalysis::passElectron1Muon1TopologyCuts(const pat::Electron& patElectron, int nobjE, const pat::Muon& patMuon, int nobjM) {
  ...
  if (_DoElectron1Muon1DiscrByCDFzeta2D) {
    if( ((_Electron1Muon1PZetaCutCoefficient * CalculatePZeta(patElectron,nobjE,patMuon,nobjM)) +
         (_Electron1Muon1PZetaVisCutCoefficient * CalculatePZetaVis(patElectron,nobjE,patMuon,nobjM))) < _Electron1Muon1CDFzeta2DMinCutValue )
      {return false;}
    if( ((_Electron1Muon1PZetaCutCoefficient * CalculatePZeta(patElectron,nobjE,patMuon,nobjM)) +
         (_Electron1Muon1PZetaVisCutCoefficient * CalculatePZetaVis(patElectron,nobjE,patMuon,nobjM))) > _Electron1Muon1CDFzeta2DMaxCutValue )
      {return false;}
  }
  // ----Missing transverse energy requirement
...
bool HiMassTauAnalysis::passElectron1Muon2TopologyCuts(const pat::Electron& patElectron, int nobjE, const pat::Muon& patMuon, int nobjM) {
  ...
  if (_DoElectron1Muon2DiscrByCDFzeta2D) {
    if( ((_Electron1Muon2PZetaCutCoefficient * CalculatePZeta(patElectron,nobjE,patMuon,nobjM)) +
         (_Electron1Muon2PZetaVisCutCoefficient * CalculatePZetaVis(patElectron,nobjE,patMuon,nobjM))) < _Electron1Muon2CDFzeta2DMinCutValue )
      {return false;}
    if( ((_Electron1Muon2PZetaCutCoefficient * CalculatePZeta(patElectron,nobjE,patMuon,nobjM)) +
         (_Electron1Muon2PZetaVisCutCoefficient * CalculatePZetaVis(patElectron,nobjE,patMuon,nobjM))) > _Electron1Muon2CDFzeta2DMaxCutValue )
      {return false;}
  }
  // ----Missing transverse energy requirement
...
bool HiMassTauAnalysis::passElectron2Muon1TopologyCuts(const pat::Electron& patElectron, int nobjE, const pat::Muon& patMuon, int nobjM) {
  ...
  if (_DoElectron2Muon1DiscrByCDFzeta2D) {
    if( ((_Electron2Muon1PZetaCutCoefficient * CalculatePZeta(patElectron,nobjE,patMuon,nobjM)) +
         (_Electron2Muon1PZetaVisCutCoefficient * CalculatePZetaVis(patElectron,nobjE,patMuon,nobjM))) < _Electron2Muon1CDFzeta2DMinCutValue )
      {return false;}
    if( ((_Electron2Muon1PZetaCutCoefficient * CalculatePZeta(patElectron,nobjE,patMuon,nobjM)) +
         (_Electron2Muon1PZetaVisCutCoefficient * CalculatePZetaVis(patElectron,nobjE,patMuon,nobjM))) > _Electron2Muon1CDFzeta2DMaxCutValue )
      {return false;}
  }
  // ----Missing transverse energy requirement
...
bool HiMassTauAnalysis::passElectron2Muon2TopologyCuts(const pat::Electron& patElectron, int nobjE, const pat::Muon& patMuon, int nobjM) {
  ...
  if (_DoElectron2Muon2DiscrByCDFzeta2D) {
    if( ((_Electron2Muon2PZetaCutCoefficient * CalculatePZeta(patElectron,nobjE,patMuon,nobjM)) +
         (_Electron2Muon2PZetaVisCutCoefficient * CalculatePZetaVis(patElectron,nobjE,patMuon,nobjM))) < _Electron2Muon2CDFzeta2DMinCutValue )
      {return false;}
    if( ((_Electron2Muon2PZetaCutCoefficient * CalculatePZeta(patElectron,nobjE,patMuon,nobjM)) +
         (_Electron2Muon2PZetaVisCutCoefficient * CalculatePZetaVis(patElectron,nobjE,patMuon,nobjM))) > _Electron2Muon2CDFzeta2DMaxCutValue )
      {return false;}
  }
  // ----Missing transverse energy requirement
...
bool HiMassTauAnalysis::passDiMuonTopologyCuts(const pat::Muon& patMuon1, int nobj1, const pat::Muon& patMuon2, int nobj2) {
  ...
  if (_DoDiMuonDiscrByCDFzeta2D) {
    if( ((_DiMuonPZetaCutCoefficient * CalculatePZeta(patMuon1,nobj1,patMuon2,nobj2)) +
         (_DiMuonPZetaVisCutCoefficient * CalculatePZetaVis(patMuon1,nobj1,patMuon2,nobj2))) < _DiMuonCDFzeta2DMinCutValue )
      {return false;}
    if( ((_DiMuonPZetaCutCoefficient * CalculatePZeta(patMuon1,nobj1,patMuon2,nobj2)) +
         (_DiMuonPZetaVisCutCoefficient * CalculatePZetaVis(patMuon1,nobj1,patMuon2,nobj2))) > _DiMuonCDFzeta2DMaxCutValue )
      {return false;}
  }
  // ----Missing transverse energy requirement
...
bool HiMassTauAnalysis::passDiElectronTopologyCuts(const pat::Electron& patElectron1, int nobj1, const pat::Electron& patElectron2, int nobj2) {
  ...
  if (_DoDiElectronDiscrByCDFzeta2D) {
    if( ((_DiElectronPZetaCutCoefficient * CalculatePZeta(patElectron1,nobj1,patElectron2,nobj2)) +
         (_DiElectronPZetaVisCutCoefficient * CalculatePZetaVis(patElectron1,nobj1,patElectron2,nobj2))) < _DiElectronCDFzeta2DMinCutValue )
      {return false;}
    if( ((_DiElectronPZetaCutCoefficient * CalculatePZeta(patElectron1,nobj1,patElectron2,nobj2)) +
         (_DiElectronPZetaVisCutCoefficient * CalculatePZetaVis(patElectron1,nobj1,patElectron2,nobj2))) > _DiElectronCDFzeta2DMaxCutValue )
      {return false;}
  }
  // ----Missing transverse energy requirement
...
bool HiMassTauAnalysis::passDiTauTopologyCuts(const pat::Tau& patTau1, int nobj1, const pat::Tau& patTau2, int nobj2) {
  ...
  if (_DoDiTauDiscrByCDFzeta2D) {
    if( ((_DiTauPZetaCutCoefficient * CalculatePZeta(patTau1,nobj1,patTau2,nobj2)) +
         (_DiTauPZetaVisCutCoefficient * CalculatePZetaVis(patTau1,nobj1,patTau2,nobj2))) < _DiTauCDFzeta2DMinCutValue )
      {return false;}
    if( ((_DiTauPZetaCutCoefficient * CalculatePZeta(patTau1,nobj1,patTau2,nobj2)) +
         (_DiTauPZetaVisCutCoefficient * CalculatePZetaVis(patTau1,nobj1,patTau2,nobj2))) > _DiTauCDFzeta2DMaxCutValue )
      {return false;}
  }
  // ----Missing transverse energy requirement
...
bool HiMassTauAnalysis::passDiJetTopologyCuts(const pat::Jet& patJet1, int nobj1, const pat::Jet& patJet2, int nobj2) {
  ...
  if (_DoDiJetDiscrByDeltaPhi) {
    if(TMath::Abs(normalizedPhi(smearedJetPtEtaPhiMVector.at(nobj1).phi() - smearedJetPtEtaPhiMVector.at(nobj2).phi())) < _DiJetMinDeltaPhiCut) {return false;}
    if(TMath::Abs(normalizedPhi(smearedJetPtEtaPhiMVector.at(nobj1).phi() - smearedJetPtEtaPhiMVector.at(nobj2).phi())) > _DiJetMaxDeltaPhiCut) {return false;}
  } 
    ...
    if((nobj1 < 0) || (nobj2 < 0)) {return false;}
      ...
      for ( pat::JetCollection::const_iterator patJet1 = _patJets->begin();patJet1 != _patJets->end(); ++patJet1 ) {
        ...
        for ( pat::JetCollection::const_iterator patJet2 = _patJets->begin();patJet2 != _patJets->end(); ++patJet2 ) {
          theNumberOfJets2++;
          if (((theNumberOfJets1 - 1) == nobj1) && ((theNumberOfJets2 - 1) == nobj2)) {
            if(fabs(smearedJetPtEtaPhiMVector.at(nobj1).eta() - smearedJetPtEtaPhiMVector.at(nobj2).eta()) < _LeadDiJetMinDeltaEtaCut) {return false;}
            if(fabs(smearedJetPtEtaPhiMVector.at(nobj1).eta() - smearedJetPtEtaPhiMVector.at(nobj2).eta()) > _LeadDiJetMaxDeltaEtaCut) {return false;}
          }
        }
      }
    }
  }
  if(_DoSUSYDiscrByLeadDiJetDeltaPhi) {
    if((nobj1 < 0) || (nobj2 < 0)) {return false;}
    else {
      int theNumberOfJets1 = 0;
      for ( pat::JetCollection::const_iterator patJet1 = _patJets->begin();patJet1 != _patJets->end(); ++patJet1 ) {
        ...
        for ( pat::JetCollection::const_iterator patJet2 = _patJets->begin();patJet2 != _patJets->end(); ++patJet2 ) {
          theNumberOfJets2++;
          if (((theNumberOfJets1 - 1) == nobj1) && ((theNumberOfJets2 - 1) == nobj2)) {
            if(TMath::Abs(normalizedPhi(smearedJetPtEtaPhiMVector.at(nobj1).phi() - smearedJetPtEtaPhiMVector.at(nobj2).phi())) < _LeadDiJetMinDeltaPhiCut) {return false;}
            if(TMath::Abs(normalizedPhi(smearedJetPtEtaPhiMVector.at(nobj1).phi() - smearedJetPtEtaPhiMVector.at(nobj2).phi())) > _LeadDiJetMaxDeltaPhiCut) {return false;}
          }
        }
      }
    }
  }
  if(_DoSUSYDiscrByLeadDiJetOSEta) {
    if((smearedJetPtEtaPhiMVector.at(nobj1).eta() * smearedJetPtEtaPhiMVector.at(nobj2).eta()) >= 0) {return false;}
  }
  if(_DoDiscrByMet) {
  ...
  for(unsigned int NpdfID = 0; NpdfID < pdfWeightVector.size();  NpdfID++){
	...
	if( (patTau->leadPFChargedHadrCand().isNonnull()) ) {
	  ...
	  _hTauJet1H3x3OverP[i][NpdfID]->Fill(patTau->hcal3x3OverPLead(),isrgluon_weight * isrgamma_weight * fsr_weight * pdfWeightVector.at(NpdfID));
        ...
        _hTauJet1ElecVetoDiscr[i][NpdfID]->Fill(patTau->tauID(_RecoTau1DiscrAgainstElectron.data()),isrgluon_weight * isrgamma_weight * fsr_weight * pdfWeightVector.at(NpdfID));
        _hTauJet1MuonVetoDiscr[i][NpdfID]->Fill(patTau->tauID(_RecoTau1DiscrAgainstMuon.data()),isrgluon_weight * isrgamma_weight * fsr_weight * pdfWeightVector.at(NpdfID));
        _hTauJet1DMFDiscrVsProng[i][NpdfID]->Fill(patTau->tauID("decayModeFindingNewDMs"),patTau->signalPFChargedHadrCands().size(),isrgluon_weight * isrgamma_weight * fsr_weight * pdfWeightVector.at(NpdfID));
        _hTauJet1IsoDiscr[i][NpdfID]->Fill(patTau->tauID(_RecoTau1DiscrByMaxIsolation.data()),isrgluon_weight * isrgamma_weight * fsr_weight * pdfWeightVector.at(NpdfID));
        if (_UseRecoTau1DiscrByIsolationFlag) {
...
/*
        ...
        if(_CalculateRecoElectron1IsolationUsingIsoDeposits) {
          ...
          relIsorho = ( patElectron->chargedHadronIso() + max(0.0, patElectron->neutralHadronIso() + patElectron->photonIso() - rhoIso*AEff03) ) / smearedElectronPtEtaPhiMVector.at(theNumberOfElectrons-1).pt();
        }
*/
        unsigned nele=gsfElectronH->size();
        for(unsigned iele=0; iele<nele;++iele) {
          ...
          if(reco::deltaR(myElectronRef->eta(), myElectronRef->phi(), patElectron->eta(), patElectron->phi()) < 0.01) {
            relIsorho = ( (*_elecIsoValPFIdDr04[0])[myElectronRef] + max(0.0, (*_elecIsoValPFIdDr04[1])[myElectronRef] +
                        (*_elecIsoValPFIdDr04[2])[myElectronRef] - rhoIso*AEff03) ) / smearedElectronPtEtaPhiMVector.at(theNumberOfElectrons-1).pt();
          }
        }
	...
	nCJets++;
      ...
      for ( pat::JetCollection::const_iterator patJet1 = _patJets->begin();patJet1 != _patJets->end(); ++patJet1 ) {
        ...
        for ( pat::JetCollection::const_iterator patJet2 = _patJets->begin();patJet2 != _patJets->end(); ++patJet2 ) {
	      ...
	      (passDiJetTopologyCuts((*patJet1),theNumberOfJets1 - 1,(*patJet2),theNumberOfJets2 - 1)) &&
              (theNumberOfJets2 > theNumberOfJets1)) {
            if(CalculateThe4Momentum((*patJet1),theNumberOfJets1-1,(*patJet2),theNumberOfJets2-1).second.M() > leaddijetmass) {leaddijetmass = CalculateThe4Momentum((*patJet1),theNumberOfJets1-1,(*patJet2),theNumberOfJets2-1).second.M();etaproduct = smearedJetPtEtaPhiMVector.at(theNumberOfJets1-1).eta() * smearedJetPtEtaPhiMVector.at(theNumberOfJets2-1).eta();}
            ...
            if(fabs(smearedJetPtEtaPhiMVector.at(theNumberOfJets1 - 1).eta() - smearedJetPtEtaPhiMVector.at(theNumberOfJets2 - 1).eta()) > leaddijetdeltaEta) {leaddijetdeltaEta = fabs(smearedJetPtEtaPhiMVector.at(theNumberOfJets1 - 1).eta() - smearedJetPtEtaPhiMVector.at(theNumberOfJets2 - 1).eta());}
            if(TMath::Abs(normalizedPhi(smearedJetPtEtaPhiMVector.at(theNumberOfJets1-1).phi() - smearedJetPtEtaPhiMVector.at(theNumberOfJets2-1).phi())) > leaddijetdeltaPhi) {leaddijetdeltaPhi = TMath::Abs(normalizedPhi(smearedJetPtEtaPhiMVector.at(theNumberOfJets1-1).phi() - smearedJetPtEtaPhiMVector.at(theNumberOfJets2-1).phi()));}
            ...
            _hDiJetDeltaEta[i][NpdfID]->Fill(fabs(smearedJetPtEtaPhiMVector.at(theNumberOfJets1-1).eta() - smearedJetPtEtaPhiMVector.at(theNumberOfJets2-1).eta()),isrgluon_weight * isrgamma_weight * fsr_weight * pdfWeightVector.at(NpdfID));
            _hDiJetDeltaPhi[i][NpdfID]->Fill(TMath::Abs(normalizedPhi(smearedJetPtEtaPhiMVector.at(theNumberOfJets1-1).phi() - smearedJetPtEtaPhiMVector.at(theNumberOfJets2-1).phi())),isrgluon_weight * isrgamma_weight * fsr_weight * pdfWeightVector.at(NpdfID));
      ...
      _hLeadDiJetDeltaPhi[i][NpdfID]->Fill(leaddijetdeltaPhi,isrgluon_weight * isrgamma_weight * fsr_weight * pdfWeightVector.at(NpdfID));
        ...
        for ( pat::JetCollection::const_iterator patJet2 = _patJets->begin();patJet2 != _patJets->end(); ++patJet2 ) {
          ...
          if ((theNumberOfJets1 == theLeadingJetIndex) && (theNumberOfJets2 == theSecondLeadingJetIndex)) {
            if( (passRecoFirstLeadingJetCuts((*patJet1),theNumberOfJets1-1)) && (passRecoSecondLeadingJetCuts((*patJet2),theNumberOfJets2-1)) && 
              ...
              _hLeadingJetsDeltaEta[i][NpdfID]->Fill(fabs(smearedJetPtEtaPhiMVector.at(theNumberOfJets1 - 1).eta() - smearedJetPtEtaPhiMVector.at(theNumberOfJets2 - 1).eta()),isrgluon_weight * isrgamma_weight * fsr_weight * pdfWeightVector.at(NpdfID));
              double dphiDijets = TMath::Abs(normalizedPhi(smearedJetPtEtaPhiMVector.at(theNumberOfJets1 - 1).phi() - smearedJetPtEtaPhiMVector.at(theNumberOfJets2 - 1).phi()));
              ...
              _hDeltaEtaVsDeltaPhiLeadSubl[i][NpdfID]->Fill(fabs(smearedJetPtEtaPhiMVector.at(theNumberOfJets1 - 1).eta() - smearedJetPtEtaPhiMVector.at(theNumberOfJets2 - 1).eta()), dphiDijets, isrgluon_weight * isrgamma_weight * fsr_weight * pdfWeightVector.at(NpdfID));
...
//-------------Dump Jet Info
void HiMassTauAnalysis::dumpRecoJet1Info(const pat::Jet& patJet,int nobj) {
  std::cout << "jet Eta      = " << smearedJetPtEtaPhiMVector.at(nobj).eta() << std::endl;
  std::cout << "jet Phi      = " << smearedJetPtEtaPhiMVector.at(nobj).phi() << std::endl;
  std::cout << "jet Pt       = " << smearedJetPtEtaPhiMVector.at(nobj).pt() << std::endl;
  std::cout << "jet Px       = " << smearedJetMomentumVector.at(nobj).px() << std::endl;
  std::cout << "jet Py       = " << smearedJetMomentumVector.at(nobj).py() << std::endl;
  std::cout << "jet Pz       = " << smearedJetMomentumVector.at(nobj).pz() << std::endl;
  std::cout << "jet E        = " << smearedJetMomentumVector.at(nobj).E() << std::endl;
  std::cout << "pass jetID   = " << passedLooseJetID(patJet,nobj) << std::endl;
  std::cout << "pass pujetID = " << passedPileupJetID(nobj) << std::endl;
}
...
void HiMassTauAnalysis::getCollections(const Event& iEvent, const EventSetup& iSetup) {
  ...
  iEvent.getByLabel(_RecoJetSource, _jets);
  ...
  iEvent.getByLabel("gsfElectrons",gsfElectronH);
  IsoDepositVals elecIsoValPFIdDr04((int)(_IsoValElecPFVInputTag.size()));
  for (size_t isoj = 0; isoj<_IsoValElecPFVInputTag.size(); ++isoj) {
    iEvent.getByLabel(_IsoValElecPFVInputTag[isoj], elecIsoValPFIdDr04[isoj]);
  }
  _elecIsoValPFIdDr04 = elecIsoValPFIdDr04;
//  electronIsoVals = &elecIsoValPFIdDr04;
}
...
bool HiMassTauAnalysis::passedLooseJetID(const pat::Jet& patJet,int nobj) {
...
bool HiMassTauAnalysis::passedPileupJetID(int nobj) {
  bool passedPUid;
//  float mva   = (*puJetIdMVA)[_jets->refAt(nobj)];
  int   idflag = (*puJetIdFlag)[_jets->refAt(nobj)];
  if(_puJetIdwp == "puJetIdLoose") {
    if( PileupJetIdentifier::passJetId( idflag, PileupJetIdentifier::kLoose ) ) {passedPUid = true;}
    else {passedPUid = false;}
  } else if(_puJetIdwp == "puJetIdMedium") {
    if( PileupJetIdentifier::passJetId( idflag, PileupJetIdentifier::kMedium ) ) {passedPUid = true;}
    else {passedPUid = false;}
  } else if(_puJetIdwp == "puJetIdTight") {
    if( PileupJetIdentifier::passJetId( idflag, PileupJetIdentifier::kTight ) ) {passedPUid = true;}
    else {passedPUid = false;}
  } else {passedPUid = true;}
  return passedPUid;
}
...
void HiMassTauAnalysis::bookHistograms(string mydirectory , unsigned int i) {
  ...
  for(unsigned int NpdfCounter = 0; NpdfCounter < pdfWeightVector.size();  NpdfCounter++){
    ...
    if (_FillRecoTauHists) {
      ...
      _hTauJet1ElecVetoDiscr[i][NpdfCounter]                     = subDir.make<TH1F>(("TauJet1ElecVetoDiscr_"+j.str()).c_str(),                     ("TauJet1ElecVetoDiscr_"+j.str()).c_str(), 2, 0, 1.5);
      _hTauJet1MuonVetoDiscr[i][NpdfCounter]                     = subDir.make<TH1F>(("TauJet1MuonVetoDiscr_"+j.str()).c_str(),                     ("TauJet1MuonVetoDiscr_"+j.str()).c_str(), 2, 0, 1.5);
      _hTauJet1IsoDiscr[i][NpdfCounter]                          = subDir.make<TH1F>(("TauJet1IsoDiscr_"+j.str()).c_str(),                          ("TauJet1IsoDiscr_"+j.str()).c_str(), 2, 0, 1.5);
      _hTauJet1DMFDiscrVsProng[i][NpdfCounter] = subDir.make<TH2F>(("TauJet1DMFDiscrVsProng_"+j.str()).c_str(), ("TauJet1DMFDiscrVsProng_"+j.str()).c_str(), 2, 0, 1.5, 10, 0, 10);      
    ...
    if (_FillRecoJetHists) {
      ...
      _hLeadDiJetDeltaPhi[i][NpdfCounter]          = subDir.make<TH1F>(("LeadDiJetDeltaPhi_"+j.str()).c_str(),         ("LeadDiJetDeltaPhi_"+j.str()).c_str(), 72, 0, +TMath::Pi());
